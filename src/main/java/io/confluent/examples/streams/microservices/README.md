...
The best place to start is [EndToEndTest.java](https://github.com/confluentinc/kafka-streams-examples/blob/6.0.x-alpha1/src/test/java/io/confluent/examples/streams/microservices/EndToEndTest.java)
