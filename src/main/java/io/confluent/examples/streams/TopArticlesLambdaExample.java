 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.0-alpha1-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.0.0-alpha1-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
